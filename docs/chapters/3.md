---
title: Rozdział III
description: "Trzeci rozdział solucji do Bractwa: Drogi Śniącego. Poszukiwania Y’Fishora, awans na Strażnika Świątynnego lub Guru i wspólna walka z orkami."
slug: /solucja/rozdzial-iii/
---

>  Rozpoczyna się po zdaniu relacji  - [Znikające ziele](./2.mdx#znikajace-ziele)
------

## Święta misja {#swieta-misja}
...
## Polowanie z Cruzem {#polowanie-z-cruzem}
...
## Umocnienie Nowej Kopalni {#umocnienie-nowej-kopalni}
...
## Spragniony Gilbert {#spragniony-gilbert}
**Zleca: Gilbert**
...
## Honorowane skórowanie - przyjęcie Strażnik {#honorowane-skorowanie-przyjecie-straznik}
**Zleca: Cor Elvardo**
...
## Eksperyment - przyjęcie Guru {#eksperyment-przyjecie-guru}
**Zleca: Baal Volos**
...
## Obowiązki guru - tylko Guru {#obowiazki-guru-tylko-guru}
**Zleca: Baal Orun**
...
## Ucieczka Sweeta {#ucieczka-sweeta}
...
## Spór między braćmi {#spor-miedzy-bracmi}
**Zleca: Tyon**
...
## Obiecująca transakcja {#obiecujaca-transakcja}
**Zleca: Abunjan**
...
## Śladami zdrajców {#sladami-zdrajcow}

**Zleca: Baal Kagan**

Po oddaniu bryłek z zadania [**Obiecująca transakcja**](#obiecujaca-transakcja) Baal Kagan chce abyśmy zabili ostatnich członków Kręgu Ziela. Wysyła nas do Kaloma, który jest jaskini obok Nowego Obozu. Następnie udajemy się do karczmy na jeziorze i rozmawiamy z Blayderem, następnie z Silasem. Szkodnik ucieka do opuszczonej chaty niedaleko jeziora. Pobijamy go, wypytujemy o Isidro i zaprowadzamy do Kaloma. Ten daje nam miksturę, którą każe wypić Blayderowi. Po jego śmierci zdajemy relację Baal Kaganowi.

## Gniew Śniącego {#gniew-sniacego}

**Zleca: Baal Kagan**

Po zakończeniu zadania [**Śladami zdrajców**](#sladami-zdrajcow) otrzymujemy zadanie odnalezienia zdrajcy- Isidro. W Starym Obozie między targowiskiem a areną, znajduje się karczma w zawalonej wieży. Rozmawiamy z cieniem przed karczmą- Gaard. Po któtkiej rozmowie, wracamy pod karczmę o godzinie 24. Biegniemy za Gaardem do kryjówki Isidro. Zabijamy ich i zdajemy relację Baal Kaganowi.
...
![Ilustracja do zadania Test zaufania](images/test-zaufania.png)
...
Jasper, jeden z więźniów Starego Obozu, drzwi otwieramy kluczem od Orry'ego, który otrzymamy jedynie podczas zadania [Zaginiony bandyta](./2.mdx#zaginiony-bandyta). Prosi nas o sztylet.

## Miejscówka {#miejscowka}
