...
Pierwsze zadanie po zostaniu nowicjuszem. Rozmawiamy z Baalem Volosem, który zleca nam, abyśmy udali się do strażnika — Gor Na Vala — po paczkę. Mamy ją dostarczyć Baalowi Lukorowi, który znajduje się w kopalni. Po oddaniu wracamy do Baala Volosa.
...
> Uwaga: do Juana należy udać się za dnia. W nocy jego dialog buguje się i kończy od razu po zagadaniu, co może skutkować softlockiem zadania i reszty fabuły.
...
> Uwaga: Wzięcie ziela od Virana uruchomi w czwartym rozdziale zadanie <a href="#/chapters/4?id=baal-kagan">Baal Kagan</a>, w którym za karę będziemy musieli oddać 500 bryłek, a Baal Orun przestanie nam sprzedawać ziele. Zadanie pozwala na oddanie ziela z własnej kieszeni, ale rozwiązanie to nie zostało uwzględnione w skryptach i ma te same konsekwencje co wzięcie ziela od Virana.
...
Salvador ginie od ran otrzymanych z ręki Siekacza.
