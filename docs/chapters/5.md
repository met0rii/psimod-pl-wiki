---
title: Rozdział V
description: "Piąty rozdział solucji do Bractwa: Drogi Śniącego. Poszukiwania pięciu kamieni ogniskujących i powrót do kopalni."
...
## Kamienie ogniskujące {#kamienie-ogniskujace}
**Zleca: Cor Elvardo**
...
## Kamień z jeziora {#kamien-z-jeziora}
**Zleca: Cor Elvardo**
...
W trakcie podróży okazuje się, że przedmiot, który Cruchot próbował oczyścić z klątwy, nie został odczarowany. Niezależnie od tego, kto weźmie kamień – zostanie przemieniony w zombie.

:::

## Kamień z Górskiej Fortecy {#kamien-z-gorskiej-fortecy}
**Zleca: Cor Elvardo**
...
## Kamień w Kanionie Trolli {#kamien-w-kanionie-trolli}
**Zleca: Cor Elvardo**
...
## Powrót do kopalni {#powrot-do-kopalni}
**Zleca: Cor Elvardo**
...
![Ilustracja do zadania Powrót do kopalni](images/powrot-do-kopalni.png)

:::warning Uwaga

Po wykonaniu zadania „Powrót do kopalni” rozpocznie się ostatni — 6. rozdział!
