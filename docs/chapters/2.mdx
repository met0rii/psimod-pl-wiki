---
title: Rozdział II
description: "Drugi rozdział solucji do Bractwa: Drogi Śniącego. Obowiązki nowicjusza, znikające ziele, wyprawy do obozów oraz wybory w zadaniach."
...
## Tylko odrobina ziela {#tylko-odrobina-ziela}
...
## Braterskie obowiązki {#braterskie-obowiazki}
**Zleca: Baal Volos**
...
Jeżeli nie wiemy, gdzie znajduje się kopalnia, odsyłam was do zadania - [Zaginony na bagnie](./1.md#zaginiony-na-bagnie)

:::

## Nowicjusz Andur {#nowicjusz-andur}
...
<Tabs queryString="nowicjusz-andur" defaultValue="oddac-mu-10-brylek">

<TabItem value="oddac-mu-10-brylek" label="Oddać mu 10 bryłek">
...
<TabItem value="powiedziec-ze-zrobilismy-to-razem" label="Powiedzieć, że zrobiliśmy to razem">
...
## Wiadomośc dla Cor Elvardo {#wiadomosc-dla-cor-elvardo}
...
## Znikające ziele {#znikajace-ziele}
...
Idziemy do Starego Obozu. Za mostem spotykamy strażnika Darro, który mówi, że nie zostaniemy wpuszczeni do Obozu. Wykonujemy misję [**Piwo dla Strażnika**](#piwo-dla-straznika).
...
## Piwo dla strażnika {#piwo-dla-straznika}
...
## Dostawa alkoholu {#dostawa-alkoholu}
...
## Przekonujący kupiec {#przekonujacy-kupiec}
...
<Tabs queryString="przekonujacy-kupiec" defaultValue="poprawny-dialog">

<TabItem value="poprawny-dialog" label="Poprawny dialog">
...
<TabItem value="ograniczenia" label="Ograniczenia">
...
<TabItem value="nagroda" label="Nagroda">
...
## Poszukiwanie gladiatorów {#poszukiwanie-gladiatorow}

**Zleca: Scatty**

Scatty poszukuje nowych gladiatorów do swojej areny. Są to:
 - Kharim z Nowego Obozu,
 - Hanis z Obozu Bractwa (Zadanie - **[Marzenie Hanisa](./1.md#marzenia-hanisa)**).

## Legendarny bandyta {#legendarny-bandyta}
...
## Kowal bez miecza {#kowal-bez-miecza}
...
Cortis musi wygrać, inaczej zadanie trafi do nieudanych!

:::

## Dług Mehrusa {#dlug-mehrusa}
...
## Herszt bandytów {#herszt-bandytow}
...
<Tabs queryString="rycerski-los" defaultValue="zabic-siekacza">

<TabItem value="zabic-siekacza" label="Zabić Siekacza">

Otrzymujemy za to 300 punktów doświadczenia.

</TabItem>
<TabItem value="zabic-salvadora" label="Zabić Salvadora">
...
W trakcie powrotu z Nowego obozu w trakcie wykonywania [**Znikające ziele**](#znikajace-ziele) gdy wracamy razem z Vasilim i Ringierem do obozu. Niedaleko jaskini z goblinami (zadanie G1 z Almanahem) spotykamy Orka zwiadowcę. Po zabiciu otrzymujemy zadanie, które zakończymy w 3 rozdziale.
