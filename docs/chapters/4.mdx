---
title: Rozdział IV
description: "Czwarty rozdział solucji do Bractwa: Drogi Śniącego. Kopalnia, Cmentarzysko Orków, starożytne języki i zagadki ruin."
...
## Miecz wojownika {#miecz-wojownika}
**Zleca: Cor Luman**
...
Zadanie warto wykonać od razu, ponieważ Gor Luman może nie pojawić się w Starym Obozie!

:::


![Ilustracja do zadania Miecz wojownika](images/miecz-wojownika.jpg)
...
<Tabs queryString="zasadzka" defaultValue="gdy-go-ostrzezemy">

<TabItem value="gdy-go-ostrzezemy" label="Gdy go ostrzeżemy">

Dostaniemy +500 expa oraz miecz "Ręka strażnika".

</TabItem>
<TabItem value="gdy-go-zwabimy" label="Gdy go zwabimy">
...
## Niebezpieczny napastnik {#niebezpieczny-napastnik}
**Zleca: Fulcher**
...
Po zabiciu Cleavera tracimy możliwość wykonania zadania z Siekaczem o zabiciu Cleavera w 5. rozdziale!

:::

## Pakt z Tobem {#pakt-z-tobem}
...
## Powrót do obozu {#powrot-do-obozu}

**Zleca: Gor Kumar**

Gor Kumar mówi nam, żebyśmy zajrzeli do chaty Cor Elvarda, więc tam się udajemy.

## W jego imieniu - zadanie Strażnika Świątynnego {#w-jego-imieniu-zadanie-straznika-swiatynnego}
...
![Ilustracja do zadania W jego imieniu](images/w-jego-imieniu.jpg)

## Koniec zamieszania {#koniec-zamieszania}
...
## Bractwo, do boju! {#bractwo-do-boju}
**Zleca: Dark**
...
## Uczieczka Sweeta {#uczieczka-sweeta}
**Zleca: Baal Orun**
...
## Język starożytnych {#jezyk-starozytnych}
**Zleca: Baal Volos**
...
![Trzy przyciski otwierające przejście na Cmentarzysku Orków](images/cmentarzysko-przyciski.jpg)


Teraz musimy znaleźć tajemniczy zwój. Poniższy obrazek pokazuje, gdzie się znajduje:

![Położenie tajemniczego zwoju na Cmentarzysku Orków](images/cmentarzysko-zwoj.png)
...
![Statuetka i przedmiot ceremonialny w zagadce Cmentarzyska Orków](images/cmentarzysko-zagadka.png)
...
## Robota dla tłumacza {#robota-dla-tlumacza}
**Zleca: Baal Volos**
...
## Język przodków Bractwa {#jezyk-przodkow-bractwa}
**Zleca: Baal Volos**
...
![Miecze i pulpity potrzebne do otwarcia mostu w ruinach miasta](images/ruiny-most.png)
...
Po wykonaniu zadania **Język przodków Bractwa** rozpoczynie się 5 rozdział!
