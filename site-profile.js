module.exports = {
  ...
  installationUrl: 'https://sefaris.eu/bractwo-droga-sniacego/installation',
  repository: 'https://github.com/met0rii/psimod-pl-wiki',
  branch: 'main',
  discordUrl: 'https://discord.gg/9EVFJv5Uyf',
  prototype: false,
};
